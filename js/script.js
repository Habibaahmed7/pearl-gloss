...
const product1=new products(' Friends Balmy Gloss','90 $','lip gloss','images/product1.png',1);
const product2=new products('Maybelline New York','150 $','lip gloss ','images/product2.png',2);
const product3=new products('Maybelline New York','120 $','lip gloss','images/product10.png',3);
const product4=new products('Essence Extreme Shine','250 $','Volume Lip Gloss','images/product3.png',4);
const product5=new products('Essence','100 $','Volume Lip Gloss','images/product4.png',5);
const product6=new products('Ruby Shade','20 $','Volume Lip Gloss ','images/product5.png',6);
const product7=new products('Essentials Lip',' 110 $','Lip Paint','images/product6.png',7);
const product8=new products('Essentials Lip','180 $','Lip Paint','images/product7.png',8);
const product9=new products('Essentials Lip','190 $','Lip Paint','images/product8.png',9);
                ...
                <h5 class="card-text">Price :  ${product[i].price}</h5>
                 <h5>Category : ${product[i].category}</h5>
                    <div class="d-flex" style="justify-content: space-between;"> 
                        <button class="btn btn-secondary" id="${product[i].id}" onclick='addItems(this.id)'>Add to cart</button>
...
let btnAdd=document.querySelectorAll('.btn-secondary')
